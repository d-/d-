...
<scrollable-region data-labelled-by="commit-badge-verified-9a05d29d-dialog-title" data-catalyst="" style="overflow: auto;">
        <div data-view-component="true" class="Overlay-body">          <div class="d-flex">
            <a class="pr-1" aria-label="d-" href="/d-">
              <img src="https://avatars.githubusercontent.com/u/1255112?s=64&amp;v=4" alt="" class="avatar avatar-2 avatar-user mr-2">
            </a>
            <span class="signed-commit-signer-name flex-1">
              <a class="signer" href="/d-">d-</a>
              
            </span>
          </div>
        <div class="signed-commit-footer pt-3">
            <span class="d-block">GPG key ID: <span class="color-fg-muted">4A123BEB863B5480</span></span>
            <div class="my-1">
            </div>
